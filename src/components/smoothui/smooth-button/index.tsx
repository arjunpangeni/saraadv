...
const smoothButtonVariants = cva(
  "relative inline-flex max-w-full cursor-pointer items-center justify-center gap-2 whitespace-normal text-center font-medium sm:whitespace-nowrap outline-none ring-offset-background transition-[transform,background-color,border-color,color,box-shadow] duration-150 ease-out focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 active:scale-[0.97] disabled:pointer-events-none disabled:opacity-50 motion-reduce:transition-none motion-reduce:active:scale-100 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    defaultVariants: {
      shape: "default",
      size: "default",
    ...
    variants: {
      ...
      size: {
        default: "h-auto min-h-10 gap-2 rounded-md px-4 py-2 text-sm [&_svg]:size-4",
        icon: "size-10 shrink-0 rounded-md [&_svg]:size-4",
        "icon-lg": "size-11 shrink-0 rounded-lg [&_svg]:size-5",
        "icon-sm": "size-9 shrink-0 rounded-md [&_svg]:size-4",
        lg: "h-auto min-h-11 gap-2 rounded-lg px-4 py-2.5 text-base sm:px-8 [&_svg]:size-5",
        sm: "h-auto min-h-9 gap-1.5 rounded-md px-3 text-sm [&_svg]:size-4",
        xs: "h-auto min-h-7 gap-1.5 rounded-sm px-2.5 text-xs [&_svg]:size-3.5",
      },
      variant: {
        candy:
